    ...
    return (
        <div className={className}>
            <NextSeo
                ...
                type: 'website',
                title: 'Andrés Coello Goyes',
                description: 'Soy software developer desde el 2018 en ambiente web y móvil multiplataforma, autodidacta, tutor y amigo para quienes necesiten de una mano en sus proyectos.',
                images: [
                    {
                        url: `${BASE_URL}/me.jpg`,
